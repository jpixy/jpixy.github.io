...
"上周的技术分享会上（S），
 你用了很多图表来解释复杂概念（B），
 大家的理解度明显提高了，会后好几个人来感谢你（I）。"

示例（改进反馈）：
"昨天的代码评审中（S），
 你直接说'这写得不对'，没有解释原因（B），
 小王看起来有些沮丧，而且他还是不清楚问题在哪（I）。"
```
...
```
背景：
老李是团队最资深的工程师，近期表现有些倦怠，觉得没有成长空间。
...
│   ├── 技术：主导一个架构升级项目
│   └── 管理：尝试带 1-2 个人
├── 安排和 Staff Engineer 的 coffee chat
├── 鼓励参加行业会议，扩大视野
└── 3 个月后再复盘方向

结果：
└── 明确选择技术专家路线，正在准备晋升 Staff
```
