...
│     类别       │              示例因子                  │
├────────────────┼───────────────────────────────────────┤
│ 风险因子       │ 市场、规模、价值、动量、波动率         │
│ (Risk Factors) │ 系统性的，不易衰减                     │
├────────────────┼───────────────────────────────────────┤
│ Alpha 因子     │ 自研因子，另类数据因子                 │
│ (Alpha Factors)│ 可能衰减，需要持续挖掘                 │
├────────────────┼───────────────────────────────────────┤
│ 价量因子       │ 均线、RSI、成交量、换手率              │
│                │ 来自技术分析                           │
├────────────────┼───────────────────────────────────────┤
