...
---## 相关文章- [Python类特殊方法](/articles/python/py-08-类特殊方法/) - 类魔术方法基础介绍
- [Python双下划线变量详解](/articles/python/py-57-Python双下划线变量详解/) - 模块级双下划线变量（`__name__`、`__file__` 等）
- [Python核心概念索引](/articles/00-glossary/glossary-06-python-concepts/) - Python 概念速查