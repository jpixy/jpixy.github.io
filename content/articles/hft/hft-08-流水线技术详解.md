...
gantt
    ...
    Task1-Stage2 :a2, 3, 6
    Task1-Stage3 :a3, 6, 9
    Task2-Stage1 :a4, 9, 12
    Task2-Stage2 :a5, 12, 15
    Task2-Stage3 :a6, 15, 18
    ...
    Task2-Stage1 :b4, 3, 6
    Task2-Stage2 :b5, 6, 9
    Task2-Stage3 :b6, 9, 12
    Task3-Stage1 :b7, 6, 9
    Task3-Stage2 :b8, 9, 12
    Task3-Stage3 :b9, 12, 15
```
...
```mermaid
graph TB
    subgraph SPSC["SPSC 无锁队列"]
        P[生产者] --> WP[write_pos]
        C[消费者] --> RP[read_pos]
        WP --> RB["环形缓冲区<br/>[0][1][2][3]...[N-1]"]
        RP --> RB
    end
```
