...
│  │    • 生成/解析 TLP (Transaction Layer Packet)                │   │
│  │    • 支持事务类型：Memory, IO, Config, Message               │   │
│  │    • 流量控制                                                │   │
│  │    • 事务排序规则                                            │   │
│  └─────────────────────────────────────────────────────────────┘   │
│                               │                                     │
...
│  │    • 包装 TLP 为 DLLP (Data Link Layer Packet)              │   │
│  │    • CRC 校验                                                │   │
│  │    • ACK/NAK 机制                                            │   │
│  │    • 重传机制                                                │   │
│  └─────────────────────────────────────────────────────────────┘   │
...
│  │ 0x38 │ Reserved                                             │    │
│  │ 0x3C │ Intr Line │ Intr Pin │ Min_Gnt │ Max_Lat             │    │
│  └────────────────────────────────────────────────────────────┘    │
│                                                                      │
...
│  ┌─────────────────────────────────────────────────────────────┐   │
│  │ 31              4 │ 3 │ 2  1 │  0  │                         │   │
│  │  Base Address     │PF │Type │Mem=0│                         │   │
│  └─────────────────────────────────────────────────────────────┘   │
│  • Bit 0 = 0: Memory Space                                          │
│  • Bit 2:1: 00=32位, 10=64位                                        │
│  • Bit 3: Prefetchable                                              │
│                                                                      │
│  Memory BAR (64-bit)：使用两个连续 BAR                              │
│  ┌─────────────────────────────────────────────────────────────┐   │
│  │ BAR n   │  Address[31:4]  │ PF │ 10 │ 0 │                    │   │
...
│  VM1      VM2      VM3                                              │
│    │        │        │                                              │
│   VF0      VF1      VF2  ← Virtual Functions (轻量级)               │
│    │        │        │                                              │
│    └────────┼────────┘                                              │
│             ▼                                                       │
│    ┌─────────────────────┐                                          │
