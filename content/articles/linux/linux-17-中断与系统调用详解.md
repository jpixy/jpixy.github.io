...
|------|------|------|
| 127:96 | Reserved | 保留 |
| 95:64 | Offset [63:32] | 中断处理程序地址高位 |
| 63:48 | Offset [31:16] | 中断处理程序地址中位 |
| 47:45 | DPL | 描述符特权级 (0=内核, 3=用户) |
| 44:40 | Type | 门类型 (Interrupt Gate / Trap Gate) |
| 39:32 | IST | 中断栈表索引 |
| 31:16 | Seg Sel | 代码段选择子 |
| 15:0 | Offset [15:0] | 中断处理程序地址低位 |
...
graph TB
    subgraph A["进程 A 内核栈"]
        A1["保存的寄存器"]
        A2["返回地址"]
        A3["switch_to<br/>保存 A 的 RSP<br/>恢复 B 的 RSP"]
        A4["..."]
    end
