...
1. [网络瓶颈根因分析](#一网络瓶颈根因分析)
2. [协议栈虚拟化与动态协议栈](#二协议栈虚拟化与动态协议栈)
3. [网络协议栈迁移](#三网络协议栈迁移)
4. [DPDK 深入解析](#四dpdk-深入解析)
5. [OVS/OVN + DPDK](#五ovsovn--dpdk)
6. [eBPF/XDP 技术栈](#六ebpfxdp-技术栈)
7. [FD.io VPP](#七fdio-vpp)
8. [PF_RING](#八pf_ring)
9. [硬件卸载：SmartNIC 与 DPU](#九硬件卸载smartnic-与-dpu)
10. [业界真实场景与最佳实践](#十业界真实场景与最佳实践)
11. [技术选型指南](#十一技术选型指南)
